...
myKeyMaps = fromList
  ...
  -- Workspace keys
  , xK_1 # windows (W.greedyView (myWorkspaces !! 0))
  , xK_2 # windows (W.greedyView (myWorkspaces !! 1))
  , xK_3 # windows (W.greedyView (myWorkspaces !! 2))
  , xK_4 # windows (W.greedyView (myWorkspaces !! 3))
  , xK_5 # windows (W.greedyView (myWorkspaces !! 4))
  , xK_6 # windows (W.greedyView (myWorkspaces !! 5))
  , xK_7 # windows (W.greedyView (myWorkspaces !! 6))
  , xK_8 # windows (W.greedyView (myWorkspaces !! 7))
  , xK_9 # windows (W.greedyView (myWorkspaces !! 8))
  , xK_0 # windows (W.greedyView (myWorkspaces !! 9))
  , xK_1 ! windows (W.shift (myWorkspaces !! 0))
  , xK_2 ! windows (W.shift (myWorkspaces !! 1))
  , xK_3 ! windows (W.shift (myWorkspaces !! 2))
  , xK_4 ! windows (W.shift (myWorkspaces !! 3))
  , xK_5 ! windows (W.shift (myWorkspaces !! 4))
  , xK_6 ! windows (W.shift (myWorkspaces !! 5))
  , xK_7 ! windows (W.shift (myWorkspaces !! 6))
  , xK_8 ! windows (W.shift (myWorkspaces !! 7))
  , xK_9 ! windows (W.shift (myWorkspaces !! 8))
  , xK_0 ! windows (W.shift (myWorkspaces !! 9))
